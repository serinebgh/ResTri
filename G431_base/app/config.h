...
/* --------------------------------------------------------- */
#define USE_SERVO           1   // Active les servos

#define SERVO1_TIM          htim1
#define SERVO1_CHANNEL      TIM_CHANNEL_1   // PA8

#define SERVO2_TIM          htim1
#define SERVO2_CHANNEL      TIM_CHANNEL_2   // PA9

#define SERVO3_TIM          htim1
#define SERVO3_CHANNEL      TIM_CHANNEL_3   // PA10

#define SERVO4_TIM          htim2
#define SERVO4_CHANNEL      TIM_CHANNEL_2   // PA1

#define SERVO5_TIM          htim3
#define SERVO5_CHANNEL      TIM_CHANNEL_1   // PA6
